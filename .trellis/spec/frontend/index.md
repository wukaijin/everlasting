...
| [Reka-UI Usage](./reka-ui-usage.md) | reka-ui 2.9.9 version pin, primitives used in project, `TextFieldRoot` not-in-2.9.9 gotcha + native `<input>` substitute, Label wrapper convention, data-state theming, anti reka-ui Popover rationale | Filled (2026-06-09, UI polish) |
