...
> 08-07-large-file-splitting: 按章节拆分为 parts,hub 保留总览。

## Part Index

- [WORKFLOW-INTEGRATION — Workflow 集成需求设计](./WORKFLOW-INTEGRATION/00-intro.md)
- [1. 文档目的](./WORKFLOW-INTEGRATION/01-doc-purpose.md)
- [2. 背景与动机](./WORKFLOW-INTEGRATION/02-background.md)
- [3. 项目能力边界(本功能)](./WORKFLOW-INTEGRATION/03-capability-boundary.md)
...
- [11. 风险与权衡](./WORKFLOW-INTEGRATION/11-risks.md)
- [12. 与现有体系的接入点(实施时接缝清单)](./WORKFLOW-INTEGRATION/12-integration-points.md)
