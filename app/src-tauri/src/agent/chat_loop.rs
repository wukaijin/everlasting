...
/// frontend.
/// Per-turn tool dispatch: L2 parallel read-only batch + serial path (L3b
/// concurrent dispatch_subagent + serial per-tool execute). Returns
