...
- ✅ 5 份设计文档(需求/架构/技术/实现/候选)
- ✅ 16 关卡架构细化(用户输入到文件变更的完整链路)
- ✅ 8 步实施路线图,标了 MVP / v1 阶段
- ✅ 核心决策全部记录(为什么不用 SDK / 为什么 WSL / 为什么 daemon 化)
- ⏳ 步骤 1:搭 Tauri 2 + Vue 3 + Vite 骨架(未开始)
...
| [docs/TECH.md](./docs/TECH.md) | 锁定了哪些库(rig-core / rmcp / git2-rs / sqlx / nucleo 等) |
...
| MVP | 3 | 切 rig-core + 项目 / 会话数据模型 |
| MVP | 4 | Git 集成(worktree + 自动 commit) |
| MVP | 5 | WSL 体验(WSLg 显示,无跨边界) |
| v1  | 6 | 嵌入式终端 + 权限系统 |
| v1  | 7 | MCP 暴露 + 多 Provider |
| 跨  | 8 | 打磨与文档 |
